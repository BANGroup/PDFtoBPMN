...
Проект включает интерактивный просмотрщик BPMN схем с поддержкой трассировки к исходным документам.

### Возможности

| Функция | Описание |
|---------|----------|
| **Открытие файлов** | Drag-drop или кнопка `📂 Открыть` |
| **Навигация** | Колесо мыши — масштаб, зажать — перемещение |
| **Drill-down** | Двойной клик на SubProcess или синяя стрелка ↘️ |
| **Информация** | Клик на элемент → панель с данными о трассировке |
| **Сохранение** | `Ctrl+S` или кнопка `💾 Сохранить` |

### Трассировка к источникам

Каждый элемент BPMN содержит ссылку на пункт исходного документа:

```
📄 РД-Б7.004-05, п.7.2

Руководитель ПФМ принимает решение о заключении договора 
на основании потребности и источника финансирования.
...
| Клавиша | Действие |
|---------|----------|
| `I` | Открыть/закрыть панель информации |
| `Escape` | Закрыть панель или вернуться назад |
| `Ctrl+O` | Открыть файл |
